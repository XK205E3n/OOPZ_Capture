...
@pytest.mark.parametrize('marker,script', [('prepare-release', 'prepare_release.ps1'), ('server-env', 'configure_server_env.ps1'), ('dependency-recovery', 'retry_dependency_install.ps1'), ('node-recovery', 'resume_node_install.ps1')])
