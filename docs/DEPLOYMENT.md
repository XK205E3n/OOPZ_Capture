...
v0.11.10 修复百炼 qwen3.8-flash 思考开关；云端建议单次超时 180 秒。配置保留原值，不会因升级自动更改，API 密钥与入口必须匹配。完整参数、401/超时区别和账户使用范围见[部署指南](../README_CLOUD_SERVER_DEPLOYMENT.md#部署前必读v01112)。
